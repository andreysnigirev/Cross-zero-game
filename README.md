#Данная программа представляет из себя реализацию игры в крестики-нолики при помощи библиотеки JavaFX. Реализован весь функционал игры в крестики-нолики: ходы, проверка победителя, проверка ничьей.
